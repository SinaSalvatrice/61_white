...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_ansi(
        ...
        _______, _______, KC_UP,   _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, _______, _______,
        ...
        _______, _______, _______,                            _______,                            _______, _______, _______, C(A(KC_DEL))
    )
